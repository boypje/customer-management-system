...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#deviceModal" data-mode="add">
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex justify-content-center">
                        ...
                        @if (auth()->user()->id == 1)
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#deviceModal" data-mode="edit" data-device="{{ json_encode($device) }}">
                            <i class="fa fa-pen"></i>
                        </button>
...
<link href="https://cdn.datatables.net/1.11.5/css/jquery.dataTables.min.css" rel="stylesheet" /> @endpush @push('js')
    ...
    $(document).ready(function() {
            ...
            $('#deviceModal').on('show.bs.modal', function (event) {
                ...
                if (mode === 'edit') {
                    ...
                    form.attr('action', '/admin/device/update/' + device.id);
