            ...
            <div class="card shadow" id="user-card">
                <div class="card-body">
                    <div class="col-md-12 user-form">
                        ...
                        <form id="platform-form" class="ajax-form" enctype="multipart/form-data">
                            <input type="hidden" name="id" id="id">

                            @csrf
                                <h3 class="zheading-small text-muted mb-5">{{ __('Input Klien') }}</h3>

                            <div class="form-group row">
                                <span class="col-md-3 col-form-label text-md-right labelclass">{{ __('Nama Klien') }}</span>
                                <div class="col-md-3">
                                    <input id="nama_platform" type="text" class="form-control @error('ktp') is-invalid @enderror" name="nama_platform" value="" required autofocus placeholder="{{ __('Contoh : Akulaku / Kredit Pintar') }}">
