...
class DeviceController extends Controller
{
    public function index()
    {
        ...
        if ($userId == 1) {
            $devices = DB::table('device')
                        ...
                        ->select('device.*', 'users.fullname as user_fullname')
    ...
    public function chats(Request $request, $id)
    {
        ...
        try {
            ...
            // Kirim data ke view
            return view('admin.devices.chat-list', compact('chatData'));
    ...
    public function Scan($id)
    {
        ...
        return view('admin.devices.scan', $data);
    }
    ...
    public function history(Request $request, $id)
    {
        ...
        return view('admin.devices.history', compact('device', 'outboxData', 'outbox'))
